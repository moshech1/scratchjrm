...
export const isTablet = /Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent);
...
export function onTouchStartBind(button,btnFun){
    if (isTablet) {
        button.ontouchstart = btnFun;
    } else {
        button.onmousedown = btnFun;
    }
}

export function onTouchMoveBind(button,btnFun){
    if (isTablet) {
        button.ontouchmove = btnFun;
    } else {
        button.onmousemove = btnFun;
    }
}

export function onTouchEndBind(button,btnFun){
    if (isTablet) {
        button.ontouchend = btnFun;
    } else {
        button.onmouseup = btnFun;
    }
}
